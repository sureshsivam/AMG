...
<table style="width:100%" border="0">
	...
	<tr>
      ...
      <tr>
		<td><font class="font_align">E-Mail ID &nbsp;&nbsp;</font><span style="font-size:11px;" ></span></td>
		 <td><?php print("<input name='mail' id='mail' class='input'  type='text' style='width:180px;' value='".$row->email."'>")
		 ?></td>
	</tr>
<?php } ?>
	</table>
